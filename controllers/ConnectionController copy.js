...
// export const getConnectionsForUser1 = async (req, res) => {
//   console.log('getConnectionsForUser hitted');
//   try {
//     const customerId = req.user.id; // Get the customer ID from req.user

//     console.log('Connection   req.user ', req.user);
...
// export const getConnectionsForUser2 = async (req, res) => {
//   try {
//     const customerId = req.user.id; // Get the customer ID from req.user
